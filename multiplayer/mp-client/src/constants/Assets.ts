...
export const ASSETS: AssetData[] = [
    ...
    { key: 'map-bsmith_2', fileName: 'bsmith_2.amd', assetType: AssetType.MAP, mapName: 'Elvine Blacksmith', minimap: Minimap.NONE },
    { key: 'map-gshop_2', fileName: 'gshop_2.amd', assetType: AssetType.MAP, mapName: 'Elvine Shop', minimap: Minimap.NONE },
    { key: 'map-wrhus_2', fileName: 'wrhus_2.amd', assetType: AssetType.MAP, mapName: 'Elvine Warehouse', minimap: Minimap.NONE },
    { key: 'map-wzdtwr_2', fileName: 'wzdtwr_2.amd', assetType: AssetType.MAP, mapName: 'Elvine Wizard Tower', minimap: Minimap.NONE },
