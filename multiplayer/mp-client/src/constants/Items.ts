...
/** `sprite-item-pack-{sheet}-{frame}` with optional `-{hex}` suffix when TINT_INVENTORY applies. */
...
function mergeWithItemDirectory(base: Item): Item {
    ...
    return {
        ...
        stackable: sv.stackable === true ? true : undefined,
        consumable: sv.consumable === true ? true : undefined,
