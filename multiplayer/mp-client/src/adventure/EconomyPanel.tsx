...
export function EconomyPanel(){
 ...
 const dialogue:Record<string,string>={shop:'Bienvenido, viajero. Aquí encontrarás provisiones; si ayudas a mantener despejados los caminos, también habrá una recompensa.',blacksmith:'El acero revela el carácter de quien lo empuña. Tengo armas rápidas, pesadas y armaduras para cada etapa de tu viaje.',magic:'El poder arcano exige inteligencia y disciplina. Aprende los conjuros en orden y vuelve cuando estés preparado.',warehouse:'Guardaré cada pieza exactamente como me la entregues. Tu almacén es personal y persiste entre aventuras.'};
 ...
 return <section className="economy" aria-label={title}>
  ...
  {open&&<div className="economy-body">
   <div className="npc-dialogue"><div><strong>{title}</strong><p>{dialogue[stats.service]}</p></div><img src="/assets/darke/ui/shopkeeper.png" alt="Mercader adulta de Aresden"/></div>
